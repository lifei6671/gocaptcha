...
func init() {
	...
	case "darwin":
		println("mac os!")
		ReadFonts("/Library/Fonts/", ".ttf")
		ReadFonts("/System/Library/Fonts/", ".ttf")
		ReadFonts("/System Folder/Fonts/", ".ttf")
		ReadFonts("/Network/Library/Fonts/", ".ttf")
		ReadFonts("~/Library/Fonts/", ".ttf")
	case "linux":
		ReadFonts("/usr/share/fonts/", ".ttf")
	case "windows":
		//I am not sure about it, please add it by yourself
	default:
		// I don't think we need this so I add a panic
		println(osName)
		println("unknown os, please Call ReadFonts or SetFontFamily by yourself")
